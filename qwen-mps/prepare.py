...
MAX_SEQ_LEN = 1024       # context length (reduced for 16GB)
TIME_BUDGET = 300        # training time budget in seconds (5 minutes)
EVAL_TOKENS = 1 * 262144   # ~262K tokens for val eval (halved for M2 speed, still statistically reliable)
...
def make_dataloader(tokenizer, B, T, split, buffer_size=1000):
    ...
    cpu_buffer = torch.empty(2 * B * T, dtype=torch.long, pin_memory=use_pin_memory)
